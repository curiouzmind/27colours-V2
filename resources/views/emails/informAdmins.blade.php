...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <!-- LOGO -->
  <tr>
    <td bgcolor="#E60707" align="center">
      <!--[if (gte mso 9)|(IE)]>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" >
        <tr>
          <td align="center" valign="top" style="padding: 40px 10px 40px 10px;">
            <a href="http://27colours.com" target="_blank">
              <img alt="27colours Logo" src="http://i1178.photobucket.com/albums/x377/samizares/logo_zps8klxsfsn.png" width="150" height="auto" style="display: block; width: 150px; max-width: 150px; min-width: 150px; font-family: 'Lato', Helvetica, Arial, sans-serif; color: #ffffff; font-size: 18px;" border="0">
            </a>
          </td>
        </tr>
      </table>
  ...
  <!-- HERO -->
  <tr>
    <td bgcolor="#E60707" align="center" style="padding: 0px 10px 0px 10px;">
      <!--[if (gte mso 9)|(IE)]>
      <table align="center" border="0" cellspacing="0" cellpadding="0" width="600">
        <tr>
          <td align="center" valign="top" width="600">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" >
        ...
        <tr>
          <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 0px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px; text-align: center;" >
            <span style="color: rgb(230, 7, 7); font-family: 'Arial', 'Helvetica', sans-serif; font-size: 15px; font-weight: bold; line-height: 15px; mso-line-height-rule: exactly; text-decoration: none;">A new user {{ $data['username']}}</span> just joined 27colours. Check out their profile below!
          </td>
        </tr>
      </table>
      <!--[if (gte mso 9)|(IE)]>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" valign="top" class="top-video-image" style="border-collapse: collapse; padding-bottom: 25px; padding-left: 0px; padding-right: 0px; padding-top: 25px;">
                                      <a href="{{url($data['profile_link'])}}" border="0" style="border: none; outline: none;">
                                        <img src="{{$data['user_image']}}" width="200" alt="" class="image-fix" style="-ms-interpolation-mode: bicubic; display: block; outline: none; text-decoration: none;">
                                      </a>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <table width="170" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td align="center" width="170" height="48" bgcolor="#FBA92B" class="button-wrapper" style="-moz-border-radius: 7px; -webkit-border-radius: 7px; background-clip: padding-box; border-collapse: collapse; border-radius: 7px; color: white; display: block;">
                                                    <a href="{{url($data['profile_link'])}}" class="inner-button" style="color: black; display: inline-block; font-family: 'Arial', 'Helvetica', sans-serif; font-size: 17px; line-height: 50px; text-decoration: none; width: 100%;"><span style="color: white;">View  User Profile</span></a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" >
        ...
        <tr>
          <td bgcolor="#f4f4f4" align="left" style="padding: 0px 30px 30px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 18px;" >
            <p style="margin: 0;">You received this email because you are a registered admin for 27colours.IF you are not, please ignore this message </p>
          </td>
        </tr>
        ...
        <tr>
          <td bgcolor="#f4f4f4" align="left" style="padding: 0px 30px 30px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 18px;" >
            <p style="margin: 0;text-transform: capitalize;">27Colours - 11, Anozie street Lekki Phase 1 - Lagos, Nigeria</p>
          </td>
        </tr>
      </table>
      <!--[if (gte mso 9)|(IE)]>
