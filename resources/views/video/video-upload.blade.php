...
<head>
    ...
    <title>Upload a Video | 27Colours</title>
    <!-- seo -->
                ...
                <div class="col-md-6 col-md-offset-5">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="text-center"><span class="fa fa-file-video-o"></span> Add a Video</h3>
                        ...
                        <div class="panel-body" style="min-height:300px;">
                            <form role="form" id="vid-upload" method="post" enctype="multipart/form-data" action="/video/create">
                                ...
                                <div class="row setup-content" id="step-1">
                                    <div class="col-xs-12">
                                        <div class="col-md-12">
                                            <h3 class="text-center text-uppercase"> Add Video</h3>
                                            <hr class="p5">
                                ...
                                <div class="row setup-content" id="step-2">
                                    <div class="col-xs-12">
                                        <div class="col-md-12">
                                            <h3 class="text-center text-uppercase"> Add Video Info</h3>
                                            <hr class="p5">
                                            <div class="form-group">
                                ...
                                <div class="row setup-content" id="step-3">
                                    <div class="col-xs-12">
                                        <div class="col-md-12">
                                            <h3 class="text-center text-uppercase"> Album Art (Optional)</h3>
                                            <hr class="p5">
