...
<head>
    ...
    <title>Password reset | 27Colours</title>
            <!-- seo -->
                ...
                <div class="col-md-4 col-md-offset-7">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <p><span class="glyphicon glyphicon-lock"></span> Password reset</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" required
                                               placeholder="{{{ Lang::get('confide::confide.e_mail') }}}" name="email" id="email"
                                ...
                                <div class="form-group last">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <button type="submit" class="btn btn-success btn-sm">
                                            {{{ Lang::get('confide::confide.forgot.submit') }}}</button>
                        ...
                        <div class="panel-footer">
                            Remember password? Click {{ HTML::linkRoute('login', 'here' )}} to sign in.
                        </div>
                    </div>
                </div>
            </div>
