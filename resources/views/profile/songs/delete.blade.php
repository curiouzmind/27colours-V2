...
<div class="wrapper">
    ...
    <div class="breadcrumbs container">
        <h3><i class="fa fa-home"></i> | Delete <i class="fa fa-user"></i> {{$song-> id }} </h3>
    </div>
                        ...
                        <div class="container">
                          ...
                          <div class="jumbotron text-center">
                            ...
                            <h3> Do you want to delete Song titled: {{$song->title }}? </h3>
                            {{Form::open(['url' => '/song/delete','class'=>'form'])}}
                            {{Form::hidden('id', $song->id)}}

                             <div class="form-group">
                              {{ Form::submit('Delete Song', ['class' => 'btn btn-primary']) }}
