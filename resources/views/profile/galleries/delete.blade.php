...
<head>
    ...
    <title>27 colours | Delete Page</title>
...
<div class="wrapper">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-1">
                     ...
                     <div class="">
                        <ul class="nav navbar-nav navbar-left">
                            <li>
                                <a href="/" class="active"><i class="fa fa-home fa-fw centered"></i> <span class="network-name"></span></a>
                            </li>
    ...
    <div class="breadcrumbs container">
        <h3><i class="fa fa-home"></i> | Delete <i class="fa fa-user"></i> {{$gallery-> id }} </h3>
    </div>
                        ...
                        <div class="container">
                          ...
                          <div class="jumbotron text-center">
                            ...
                            <h3> Do you want to delete this photo: {{$gallery->id }}? </h3>
                            {{Form::open(['url' => '/gallery/delete','class'=>'form'])}}
